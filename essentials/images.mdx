...
De lo contrario, recomendamos alojarse en un servicio como [Cloudinary](https://cloudinary.com/) or [S3](https://aws.amazon.com/s3/) You can then use that URL and embed.
